...
import avatar9 from "@/assets/avatar-10.png";
...
const testimonials = [
  ...
  },
  {
    ...
    name: "Harsh Chavan",
    username: "harsh.chavan@innovare.dev",
  },
];
      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5 text-white text-opacity-30 pb-10">
            Hear from our members: Inspiring journeys, impactful experiences,
            and a community that drives innovation.
          </p>
        </div>
