...
export const Feature = ({ title, description}: {title: string; description: string}) => {
    ...
    return <div className="border-[1.5px] border-white/20 px-5 py-10 text-center rounded-xl sm:flex-1 relative">
        <motion.div className="absolute inset-0 border-[1.5px] border-purple-400 rounded-xl" 
        style={{
