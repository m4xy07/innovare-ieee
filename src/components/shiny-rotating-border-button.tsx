    ...
    >
      ...
      <span className="relative z-10 block rounded-full bg-white px-3 py-1 dark:bg-neutral-800">
        <motion.span
          ...
          className="transform-gpu bg-clip-text text-neutral-600 text-lg px-2 tracking-tighter transition-colors duration-500 group-hover:text-transparent dark:text-neutral-200"
          transition={{
            duration: 1,
            ease: "linear",
            repeat: Number.POSITIVE_INFINITY,
