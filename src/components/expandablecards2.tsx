...
const cards = [
  {
    description: "Charting new frontiers",
    title: "IEEE Innovare Inaugration",
    src: "https://raw.githubusercontent.com/m4xy07/innovare-website-ieee/refs/heads/main/Reports/chrome_L6I8NuKvw0.webp",
    ctaText: "View Report",
    ctaLink:
      "https://drive.google.com/file/d/1fr62GijszSZfPry09B0tYIW0GXu4LhBS/view",
    content: () => {
      return (
        <p>
          The inaugural of the IEEE branch marks the start of fostering
          innovation. With a gathering of bright minds, the event has set the
          stage for knowledge sharing, networking, and collaborative growth.
          Esteemed speakers from the tech industry inspired attendees with their
          insights, while the ceremony highlighted the branch&apos;s mission to
          foster learning, innovation, and leadership in engineering and
          technology. <br /> <br /> The initiative promises the energising of
          participants to actively contribute to the IEEE community. The
          programme concluded with a call to action, encouraging all to be a
